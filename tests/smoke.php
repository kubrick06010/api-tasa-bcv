...
$GLOBALS['ob_test_transient_ttls'] = array();
...
function set_transient($key, $value, $ttl) { $GLOBALS['ob_test_transients'][$key] = $value; $GLOBALS['ob_test_transient_ttls'][$key] = $ttl; return true; }
...
ob_test_assert(OB_BCV_CACHE_TTL === 14400 && OB_BCV_STALE_TTL === 604800, 'cache TTLs');
...
$valid_html = '<div id="dolar"><strong>36,1234</strong></div>'
    . '<div id="euro"><strong>39,5012</strong></div>'
    . '<div id="yuan"><strong>4,995</strong></div>'
    . '<div id="lira"><strong>16,1446144</strong></div>'
    . '<div id="rublo"><strong>9,10428493</strong></div>';
$GLOBALS['ob_test_remote_response'] = array('response' => array('code' => 200), 'body' => $valid_html);
$GLOBALS['ob_test_transients'] = array();
$fetched = ob_obtener_datos_bcv(true);
ob_test_assert(!is_wp_error($fetched), 'valid response is cached');
ob_test_assert($GLOBALS['ob_test_transient_ttls'][OB_BCV_FRESH_CACHE_KEY] === OB_BCV_CACHE_TTL, 'fresh cache TTL');
ob_test_assert($GLOBALS['ob_test_transient_ttls'][OB_BCV_STALE_CACHE_KEY] === OB_BCV_STALE_TTL, 'stale cache TTL');

ob_test_assert(is_wp_error(ob_parsear_tasas_bcv('')), 'empty HTML is rejected');
